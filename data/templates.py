...
TEMPLATES = {
    ...
    "Push/Pull 4-Tage": {
        ...
        "days": {
            ...
            "Pull B": ["Lat", "Oberer Rücken", "Schulter Hinten", "Biceps", "Glutes", "Abs"],
        },
    ...
    "Upper/Lower 4-Tage": {
        ...
        "days": {
            ...
            "Lower A": ["Quads", "Hamstrings", "Calves"],
            "Upper B": ["Chest", "Lat", "Schulter Hinten", "Schulter Seite", "Biceps"],
            "Lower B": ["Quads", "Glutes", "Calves", "Abs"],
        },
    ...
    "Upper/Lower 5-Tage": {
        ...
        "days": {
            ...
            "Lower A":  ["Quads", "Hamstrings", "Calves"],
            "Upper B":  ["Chest", "Lat", "Schulter Hinten", "Biceps", "Triceps"],
            "Lower B":  ["Quads", "Glutes", "Abs"],
    ...
    "Full Body 3-Tage": {
        ...
        "days": {
            ...
            "Full Body B": ["Chest", "Lat", "Oberer Rücken", "Schulter Hinten", "Quads", "Biceps", "Triceps"],
            "Full Body C": ["Chest", "Lat", "Schulter Seite", "Glutes", "Hamstrings", "Calves", "Abs"],
        },
