...
TEMPLATES = {
    ...
    "Push/Pull 4-Tage": {
        ...
        "days": {
            ...
            "Pull A": ["Lat", "Oberer Rücken", "Schulter Hinten", "Biceps", "Hamstrings", "Glutes"],
            "Push B": ["Chest", "Schulter Seite", "Triceps", "Quads", "Calves"],
            "Pull B": ["Lat", "Oberer Rücken", "Schulter Hinten", "Biceps", "Hamstrings", "Abs"],
        },
    ...
    "Upper/Lower 4-Tage": {
        ...
        "days": {
            "Upper A": ["Chest", "Lat", "Oberer Rücken", "Schulter Seite", "Schulter Hinten", "Triceps"],
            "Lower A": ["Quads", "Hamstrings", "Glutes", "Calves"],
            "Upper B": ["Chest", "Lat", "Oberer Rücken", "Schulter Seite", "Schulter Hinten", "Biceps"],
    ...
    "Upper/Lower 5-Tage": {
        ...
        "days": {
            ...
            "Arms":     ["Schulter Seite", "Schulter Hinten", "Biceps", "Triceps", "Calves"],
        },
    ...
    "Full Body 3-Tage": {
        ...
        "days": {
            "Full Body A": ["Chest", "Lat", "Schulter Seite", "Quads", "Hamstrings", "Calves"],
            "Full Body B": ["Chest", "Lat", "Oberer Rücken", "Schulter Hinten", "Glutes", "Biceps", "Triceps"],
            "Full Body C": ["Chest", "Lat", "Schulter Seite", "Quads", "Hamstrings", "Abs"],
        },
    ...
    "Bro Split 5-Tage": {
        ...
        "days": {
            ...
            "Shoulders":  ["Schulter Seite", "Schulter Hinten"],
